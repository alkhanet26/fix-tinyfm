...
wget --no-check-certificate https://raw.githubusercontent.com/alkhanet26/fix-tinyfm/main/oceditor.php -O /www/tinyfm/oceditor.php && chmod 644 /www/tinyfm/oceditor.php
